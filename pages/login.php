                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    ...
                                    <?php endif; ?>
                                    <h2 class="card-title text-center pb-0 fs-4">PATIENT Login </h2>
                                    <p class="text-center small">Enter your email & password to login</p>
                                </div>
                                <form class="row g-3 needs-validation" action="<?= url('controller/patient_log.php') ?>" method="post">

                                    <div class="col-12">
                                        <label for="FullName" class="form-label">FullName</label>
                                        <div class="input-group has-validation">
                                            <input type="text" name="FullName" class="form-control" id="yourUserFullName" required>
